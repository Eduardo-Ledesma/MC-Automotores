            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-around">
                <div className="text-white px-4 text-center">
                    ...
                    <div className="flex flex-col gap-4 mt-6">
                        ...
                        <ul className="flex justify-center mb-10 gap-4">
                            <li>
